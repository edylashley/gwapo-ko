    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 w-full max-w-2xl relative animate-fadeInUp">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-3">
                ...
                <button id="goToTeamAssignmentBtn" class="px-3 py-1 bg-green-100 text-green-700 hover:bg-green-200 rounded-md text-sm font-medium transition-colors duration-200 flex items-center">
                    <i class="fas fa-plus-circle mr-1"></i> Add Engineer
                </button>
            </div>
            
            <script>
                document.getElementById('goToTeamAssignmentBtn')?.addEventListener('click', function() {
                    ...
                    if (projectId) {
                        ...
                        // Navigate to the monthly assignments page with the project ID as a query parameter
                        // and a hash for scrolling to the specific project
                        window.location.href = `/monthly-assignments?highlight_project=${projectId}`;
                    } else {
                        console.error('Project ID not found');
                        showCenteredNotification('Error: Could not determine project', 'error', 1000);
                    }
                });
            </script>
            ...
            <div>
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input 
                        ...
                        min="0" 
                        step="1" 
                        class="salary-input focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 pr-1 sm:text-sm border-gray-300 rounded-md py-2 border" 
                        placeholder="0.00">
                </div>
            </div>
